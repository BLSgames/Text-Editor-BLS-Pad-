...
theme_choice=tk.StringVar()   #variable for theme choice
...
font_family=tk.StringVar()    # variable for font choice
...
### size box
size_var=tk.IntVar()   # variable for 
